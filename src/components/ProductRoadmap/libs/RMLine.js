...
export default (scene, data) => {
  const startPoint = new THREE.Vector3(data.start.position.x, data.start.position.y, 0)
  const endPoint = new THREE.Vector3(data.end.position.x, data.end.position.y, 0)
